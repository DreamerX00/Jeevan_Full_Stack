...
/**
 * Web-specific controller for handling prescription operations via REST API.
 * This controller is specifically for the web application.
 */
@RestController
@RequestMapping("/api/web/prescriptions")
class PrescriptionWebController(private val prescriptionService: PrescriptionService) {
